...
while true; do
    ...
    echo "rclone move işlemi başlatılıyor..." && rclone move /mnt/up1/ awsx:/1x/ --transfers=16 --checkers=32 --s3-chunk-size=256M --fast-list --multi-thread-streams=32 --low-level-retries=30 --timeout=15s --progress --log-file /root/rclone.log 
