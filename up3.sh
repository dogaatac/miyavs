...
while true; do
    ...
    rclone move /mnt/up3/ awsx:$BUCKET_NAME/ --transfers=16 --checkers=32 --s3-chunk-size=32M --fast-list --multi-thread-streams=32 --low-level-retries=30 --timeout=15s --progress --log-file /root/rclone.log
